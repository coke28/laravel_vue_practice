        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <p class="text-secondary">Online Users: <span class="card-count" id="online-user-count">Loading...</span></p>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-6 mb-4">
            <div class="card h-100">
                <div class="card-body text-center">
                    ...
                    <p class="text-secondary">Active Forms: <span class="card-count" id="active-form-count">Loading...</span></p>
                </div>
            </div>
        </div>
