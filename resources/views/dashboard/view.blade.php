        ...
        <div class="row">
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="text-primary">Online Users: <span class="card-count"
                                id="online-user-count">Loading...</span>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="card h-100">
                    <div class="card-body text-center">
                        ...
                        <p class="text-primary">Active Forms: <span class="card-count"
                                id="active-form-count">Loading...</span>
                        </p>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-md-12 mb-4">
                    <div class="card h-100">
                        <div class="card-body text-center">
                            <tabs-vue :tabs='@json($tabs)'></tabs-vue>
                        </div>
                    </div>
                </div>
